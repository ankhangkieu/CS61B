...
public class GraphBuildingHandler extends DefaultHandler {
    ...
    private ArrayList<Long> wayContaining = new ArrayList<>();
...
//            System.out.println("Node lat: " + attributes.getValue("lat"));
            ...
            GraphDB.Node node = new GraphDB.Node(nodeID, nodeLat, nodeLon);
            this.lastNode = node;
            this.g.addNode(node);
...
//            System.out.println("Beginning a way...");
            ...
            wayContaining.add(Long.parseLong(attributes.getValue("ref")));
...
//            System.out.println("Finishing a way...");
            if (wayValid) {
                g.addEdge(wayContaining, wayID, wayName, wayMaxSpeed);
            }
            resetWay();
        }
    }
